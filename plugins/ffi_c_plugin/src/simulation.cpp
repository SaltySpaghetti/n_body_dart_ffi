...
NBody::NBody(int particles_amount, double canvas_width, double canvas_height,
             double min_mass, double max_mass)
    : m_particles_amount(particles_amount), m_canvas_width(canvas_width),
      m_canvas_height(canvas_height), m_min_mass(min_mass),
      m_max_mass(max_mass){};
